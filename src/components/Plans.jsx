...
// import { AboutSide, mapgroup, mapsideimg, palgroupA, palgroupB, planA, planB, planC, planD, safariimg, safarisecond } from '../assets/img';
...
const Plans = () => {
  ...
  const handlePlanToggle = (plan) => {
    setActivePlan(plan);
    // Reset palgroup selection when changing plan type
    setActivePalgroup('A');
  };
